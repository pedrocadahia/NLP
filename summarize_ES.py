...
# python cod.py 172.22.248.206:9229 aeacus_kdd 172.22.248.206:9229 pruebas 03_002-008_14.PDF name
import sys
...
def load_data_into_es(newesconn, INDEX_NAME, TYPE_NAME, name, vec_list):
    ...
    i = 1
    filename = name
    print(list(range(0,len(vec_list))))
    print(vec_list[2])
...
if __name__ == "__main__":
    ...
    try:
        ...
        load_execution_result_into_elastic(sys.argv[3], sys.argv[4], sys.argv[5], arguments, "success")
    # print(res(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6]))
    except:
        error_control = load_execution_result_into_elastic(sys.argv[3], sys.argv[4], sys.argv[5], arguments, "failure")
        print(error_control)
